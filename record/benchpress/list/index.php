...
echo css_load('/record/benchpress/list/index.css');
?>


<div class="record_page_header">
    <div class="page_header_inner">
        <p class="page_title_text">BenchPress</p>
        <p class="page_sub_text">벤치프레스 기록 현황</p>
    </div>
</div>
...
<?php
echo script_load('/record/benchpress/list/index.js');
?>
<script>
$(function () {
    init();
