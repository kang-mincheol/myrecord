                    ...
                    if(thisData["record_id"]) {
                        renderHtml +=
                            '<div class="record_weight">'+
                                '<a class="record_link" href="/record/record_view/?record_id='+thisData["record_id"]+'">'+thisData["weight"]+'<i class="fa-solid fa-arrow-up-right-from-square"></i></a>'+
                            '</div>'+
                            '<div class="record_status">'+
                                '<i class="fa-solid fa-circle-check '+thisData["status_color"]+'"></i>'+
                                '<p class="status_text">'+
                                    '<a class="record_link" href="/record/record_view/?record_id='+thisData["record_id"]+'">'+thisData["status"]+'</a>'+
                                '</p>'+
                            '</div>';
                    } else {
                        renderHtml +=
