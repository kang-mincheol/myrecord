...
<div id="section_1">
    <div class="bg_layer">
        <div class="section_text_wrap">
            <p class="badge_text">관리자 직접 검증 · 전문가 심사 서비스</p>
            <p class="text_1">
                스트롱맨 시청자 출신<br>
                관리자가 직접 검증하는<br>
                3대측정
...
<div id="section_2">
    <div class="section_inner">
        ...
        <p class="section_sub">간단한 4단계로 나의 기록을 검증받으세요</p>
...
<div id="section_3">
    <div class="section_wrap">
        <p class="section_3_title">지금 바로 나의 기록을 검증받으세요</p>
        <p class="section_3_sub">3대 운동 기록을 등록하고 기록서를 발급받으세요</p>
